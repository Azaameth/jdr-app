...
<!-- Expliquez le changement et liez l'issue : Closes #123. -->
...
- [ ] `npm run build`
- [ ] Tests e2e executes ou non applicables

## Verification fonctionnelle

<!-- Decrivez le scenario verifie et joignez une capture si l'interface change. -->
